 ...
 * @author Sergio
 */
public class ListarMoniUI extends javax.swing.JPanel {
     ...
     */
    public ListarMoniUI(MonitorDAO local, MarcaDAO LasMarcas) {
    ...
    private void initComponents() {
        ...
        JL_TituloListaMoni = new javax.swing.JLabel();
        ...
        JL_TituloListaMoni.setBackground(new java.awt.Color(0, 255, 255));
        JL_TituloListaMoni.setFont(new java.awt.Font("Arial Black", 2, 18)); // NOI18N
        JL_TituloListaMoni.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        JL_TituloListaMoni.setText("Formulario para listar monitores");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(44, 44, 44)
                        .addComponent(JL_TituloListaMoni))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(31, 31, 31)
    ...
    private void JB_CargarListaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_CargarListaActionPerformed
        ...
        this.jTable1.setModel(this.LosMoni.crearTabla(LasMarcas));
    ...
    private javax.swing.JLabel JL_TituloListaMoni;
