...
public class AgregarimpresoraUI extends javax.swing.JPanel {
    ...
    public AgregarimpresoraUI(impresoraDAO local, MarcaDAO lasMarcas) {
        ...
        for (int i = 0; i < this.LasMarcas.getSize(); i++) {
            ...
            this.JCB_Marcaimpresora.addItem(tmp);
        }
    ...
    private void initComponents() {
        ...
        JL_Tituloformulario.setText("Formulario para agregar impresora");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(JCB_Marcaimpresora))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void JB_RegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_RegistrarActionPerformed
        ...
        try {
            ...
            MarcaVO tmp = (MarcaVO) this.JCB_Marcaimpresora.getSelectedItem();
            
            String marca = "" + (tmp.getID());
            int ID = Integer.parseInt(this.JT_ID.getText());
            if (Lasimpresoras.almacenar(tipo, ID, Serie, marca)) {
                CUN.Msn("impresora registrada");
                this.JT_Tipo.setText("");
                this.JT_Serie.setText("");
                this.JCB_Marcaimpresora.setSelectedIndex(0);
                this.JT_ID.setText("");
    ...
    private void JB_saberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_saberActionPerformed
        ...
        int pos = this.JCB_Marcaimpresora.getSelectedIndex();
        impresoraVO tmp = (impresoraVO) this.JCB_Marcaimpresora.getSelectedItem();
        int ID = tmp.getID();
    ...
    private javax.swing.JComboBox<MarcaVO> JCB_Marcaimpresora;
